...
public class FieldUtils {
     ...
     * @throws ArithmeticException if the value is too big or too
     *  small
     */
    ...
    /**
     * Multiply two values to return an int throwing an exception if
     * overflow occurs.
     *
     * @param val1  the first value
     * @param val2  the second value
     ...
     * @throws IllegalFieldValueException if value is not in the
     *  specified bounds
     */
     ...
     * the new value lies within the field's legal value range.
     *
     * @param currentValue the current value of the data, which may
     *  lie outside
    ...
    /**
     * Utility method that ensures the given value lies within the
